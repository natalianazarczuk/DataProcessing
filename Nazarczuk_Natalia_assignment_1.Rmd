...
Badges <- read.csv("C:/Users/sebjan/OneDrive/Pulpit/hw1/Badges.csv.gz")
Comments <- read.csv("C:/Users/sebjan/OneDrive/Pulpit/hw1/Comments.csv.gz")
PostLinks <- read.csv("C:/Users/sebjan/OneDrive/Pulpit/hw1/PostLinks.csv.gz")
Posts <- read.csv("C:/Users/sebjan/OneDrive/Pulpit/hw1/Posts.csv.gz")
Tags <- read.csv("C:/Users/sebjan/OneDrive/Pulpit/hw1/Tags.csv.gz")
Users <- read.csv("C:/Users/sebjan/OneDrive/Pulpit/hw1/Users.csv.gz")
Votes <- read.csv("C:/Users/sebjan/OneDrive/Pulpit/hw1/Votes.csv.gz")
```
...
Comparison of the execution times of each function is presented below. We can see that function ---- is the fastest and function ---- is the slowest.
```{r micro1, warning=FALSE}
